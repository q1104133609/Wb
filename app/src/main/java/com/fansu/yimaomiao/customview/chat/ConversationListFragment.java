package com.fansu.yimaomiao.customview.chat;
...
public class ConversationListFragment  extends EaseBaseFragment {
    ...
    protected void initView() {
        ...
        View emptyView = LayoutInflater.from(getActivity()).inflate(R.layout.chat_empty_view, null);
        ...
        ((ViewGroup)conversationListView.getParent()).addView(emptyView);
    ...
    public void refresh() {
        ...
        if (listItemClickListener!=null) {
            listItemClickListener.onRefreshComplete();
        }
    }
